...
def create_graph_edges(workflow_ids, parent_to_children, excluded):
    '''
    (list, dict) -> list
    ...
    {'Samples': {'TumourWT': {'library_type': 'WT',
     ...
     'Data': {'Sequencing': {'workflows': ['bcl2fastq'], 'inputs': []},
      ...
      'NormalWGalign': {'samples': ['NormalWG'],
       ...
       'data': ['Sequencing'],
       'workflows': ['bwaMem']}},
     'Analysis': {'mutect2_matched': {'samples': ['NormalWG', 'TumourWG'],
       'inputs': ['bamMergePreprocessing_by_sample']},
      'variantEffectPredictor_matched': {'samples': ['NormalWG', 'TumourWG'],
       'inputs': ['mutect2_matched']},
      'delly_matched': {'samples': ['NormalWG', 'TumourWG'],
      ...
      'bamMergePreprocessing_by_sample': {'samples': ['NormalWG', 'TumourWG'],
       'inputs': ['bwaMem']},
      'bwaMem': {'samples': ['NormalWG', 'TumourWG'], 'inputs': ['bcl2fastq']},
      'rsem': {'samples': ['TumourWT'], 'inputs': ['star_call_ready']},
      'star_call_ready': {'samples': ['TumourWT'], 'inputs': ['bcl2fastq']},
      'starfusion': {'samples': ['TumourWT'], 'inputs': ['star_call_ready']},
      'arriba': {'samples': ['TumourWT'], 'inputs': ['star_call_ready']},
      'msisensor': {'samples': ['NormalWG', 'TumourWG'],
       'inputs': ['bamMergePreprocessing_by_sample']},
      'star_lane_level': {'samples': ['TumourWT'], 'inputs': ['bcl2fastq']},
      'mavis': {'samples': ['TumourWT', 'NormalWG', 'TumourWG'],
       'inputs': ['bamMergePreprocessing_by_sample',
        'star_call_ready',
        'starfusion',
...
def find_sample_groups_with_related_workflows(samples_workflows, group):
    '''
    (dict, list) -> dict
...
def identify_blocks(group, samples_workflows, parent_workflows, children_workflows, anchor_samples):
    ...
    for samples in sample_group:
       # check if paired sample or single sample
       D = find_sample_groups_with_related_workflows(samples_workflows, samples)
       if D:
           blocks = identify_analysis_workflows(D, parent_workflows, children_workflows, list(anchor_samples.keys()))
           L.append(blocks)
...
generate_cache('provenance_reporter.json', 'enabled_workflows.json', 'waterzooi_db_case_MOH.db', 'http://pinery.gsi.oicr.on.ca/assays', 'analysis_review_case_MOH_test.db', table='templates')
